...
class Mgtv:
    ...
    def run(self, url):
        ...
        title = re.findall('partName:"(.*)",hollywoodStudio', rep.text)[0]
        ...
        while not _url:
            try:
                iframe = driver.find_elements_by_tag_name("iframe")[0]
                driver.switch_to_frame(iframe)
                _url = driver.execute_script(
                    "return dp.option.video.url[0];")
            except BaseException:
                pass
            time.sleep(1)
        driver.quit()
...
if __name__ == "__main__":
    get(url='https://www.mgtv.com/b/337284/8174348.html')
